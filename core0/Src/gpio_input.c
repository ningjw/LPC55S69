...
void BOARD_InitPinsInput(void)
{
...
#ifdef PIO0_27
	gpio_pin_config_t NB_RXD_config = {
        .pinDirection = kGPIO_DigitalInput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PIO0_27 (pin N2)  */
    GPIO_PinInit(BOARD_NB_RXD_GPIO, BOARD_NB_RXD_PORT, BOARD_NB_RXD_PIN, &NB_RXD_config);
...
#ifdef PIO0_29
	gpio_pin_config_t gpio0_pinH8_config = {
        .pinDirection = kGPIO_DigitalInput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PIO0_29 (pin H8)  */
    GPIO_PinInit(GPIO, 0U, 29U, &gpio0_pinH8_config);
...
#ifdef PIO0_26
	gpio_pin_config_t NB_TXD_config = {
        .pinDirection = kGPIO_DigitalInput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PIO0_26 (pin H12)  */
    GPIO_PinInit(BOARD_NB_TXD_GPIO, BOARD_NB_TXD_PORT, BOARD_NB_TXD_PIN, &NB_TXD_config);
	...
	IOCON->PIO[0][26] = ((IOCON->PIO[0][26] &
                         ...
                         /* Selects pin function.
                          * : PORT026 (pin H12) is configured as PIO0_26. */
...
#endif
#ifdef PIO0_2
	gpio_pin_config_t BT_TXD_config = {
        .pinDirection = kGPIO_DigitalInput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PIO0_2 (pin B11)  */
    GPIO_PinInit(BOARD_BT_TXD_GPIO, BOARD_BT_TXD_PORT, BOARD_BT_TXD_PIN, &BT_TXD_config);
